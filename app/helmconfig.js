...
import chromecon from 'file!images/android-icon-192x192.png';
import applecon from 'file!images/apple-icon-180x180.png';
import mscon from 'file!images/ms-icon-70x70.png';
import favicon from 'file!images/favicon-16x16.png';
...
const config = {
  link: [
    ...
    { "rel": "apple-touch-icon", "sizes": "180x180", applecon },
    { "rel": "stylesheet", "href": "https://fonts.googleapis.com/css?family=Montserrat:400,700%7COpen+Sans:300italic,400italic,600italic,700italic,800italic,300,400,600,700", "type": "text/css" },    
  ...
  meta: [
    ...
    { "name": "description", "content": "A simple app to share collections with people" },
    ...
    { "name": "apple-mobile-web-app-title", "content": "Preview" },
